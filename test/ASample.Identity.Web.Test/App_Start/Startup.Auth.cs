...
using Owin;
using ASample.Identity.Web.Test.Models;
using ASample.ThirdParty.OAuth.Weibo;
...
namespace ASample.Identity.Web.Test
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(ASampleWebIdentityTestContext.Create);
            ...
            //    appId: "1588412454",
            //    appSecret: "259a80d6872f0697f3270a49f698e9fe");

            //app.UseGoogleAuthentication(new GoogleOAuth2AuthenticationOptions()
            //{
            //    ClientId = "971457656365-40glc5vm31qhq4a1gr3ersakpic592ao.apps.googleusercontent.com",
            //    ClientSecret = "HP7pqNVd2og-Tmesj7gbiQkq"
